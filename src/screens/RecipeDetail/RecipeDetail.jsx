...
export default function RecipeDetail() {
  ...
  const { recipes, addToShoppingList } = useApp();
      ...
      <TopBar
        ...
        rightContent={
          <button
            ...
            style={{ display:'flex', alignItems:'center', justifyContent:'center', width:36, height:36, flexShrink:0, background:'none', border:'1.5px solid var(--border)', borderRadius:14, cursor:'pointer', color:'var(--navy)', transition:'background 150ms ease, border-color 150ms ease' }}
              ...
              <>
                ...
                <div className={styles.costSummary}>
                  <div className={styles.costRow}>
                    ...
                    <span className={styles.costValueNavy}>
                      {scaledTotalCost.toFixed(2).replace('.', ',')} zł
                    </span>
                  </div>
                  <div className={styles.costRow}>
                    <span className={styles.costLabel}>{t('detail.costPer')}</span>
                    <span className={styles.costValueGreen}>
                      {scaledCostPerPortion.toFixed(2).replace('.', ',')} zł
                    </span>
                  </div>
                </div>
              </>
            ...
            {activeTab === 'video' && (
              <div className={styles.videoTab}>
                ...
                <div className={styles.videoInputRow}>
                  ...
                  />
                  <button className={styles.videoBtn} onClick={handleAddVideo}>
                    {t('detail.add')}
                  </button>
                </div>
              </div>
